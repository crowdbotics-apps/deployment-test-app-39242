...
## Project Structure
    ...
    ├── deployment_test_app_39242  # Django project configurations
...
1. Clone this repo and `cd deployment_test_app_39242`
...
2. Clone this repo and `cd deployment_test_app_39242`
